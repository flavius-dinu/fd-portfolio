...
const Services = () => {
    return (
        <div name='services' className='w-full md:h-screen bg-[#0a192f] text-[#67d6ab] items-center'>
            <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
                <div className='pb-8'>
                    <p className='text-4xl font-bold inline'>Services</p>
                </div>

                <div className="grid grid-flow-col grid-rows-1 grid-cols-3 gap-x-4 gap-y-4">
                    <div className="block p-6 max-w-sm overflow-hidden shadow-lg border rounded-lg bg-gray-800 border-gray-700 hover:bg-gray-700">
